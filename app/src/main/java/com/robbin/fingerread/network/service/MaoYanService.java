...
public interface MaoYanService {
    ...
    public Observable<MovieCelebrity> getMovieCelebrity(@Path("id")int id);
    ...
    public Observable<MovieMajor> getMovieMajor(@Path("id")int id);
    ...
    public Observable<MovieBox> getMovieBox(@Path("id")int id);

    @Headers(RetrofitManager.CACHE_CONTROL_AGE + RetrofitManager.CACHE_STALE_SHORT)
    @GET("mmdb/comments/pro/movie/{id}.json")
    public Observable<MovieCommonsZY> getMovieCommonsZY(@Path("id")int id,
    ...
    public Observable<MovieCommonsDP> getMovieCommonsDP(@Path("id")int id,@Query("token")String token,
